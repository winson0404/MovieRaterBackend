"""
Django settings for MovieRater_Backend project.
...
SECRET_KEY = 'django-insecure-ad3zj2v_)c@-g!g@yv5o@u%vj^2^72(h6+8!2pv^h43d^tw3q#'
...
ROOT_URLCONF = 'MovieRater_Backend.urls'
...
WSGI_APPLICATION = 'MovieRater_Backend.wsgi.application'
